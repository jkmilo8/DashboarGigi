<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Staff.aspx.cs" Inherits="ggi_dashboard_app.Staff" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">

    <title>GGI Staff</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <div id="panel" class="panel panel-default widget-body bordered-left bordered-green">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <br />
                            <input id="btnSearch" type="button" value="Load" class="btn btn-primary btn-primary basic btn-success" onclick="GetStaffInfo()" />
                        </div>
                    </div>
            ...
            <div id="panel-table" class="panel panel-default widget-body bordered-left bordered-green">
                <table id="StaffTable" class="table  table-bordered">
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="5" style="text-align: right" class="tfoot">Total:</th>
                            <th class="tfoot"></th>
                            <th class="tfoot"></th>
                        </tr>
                    </tfoot>
        ...
        <script src="Scripts/ggiStaff.js"></script>
    </form>
</body>
</html>
